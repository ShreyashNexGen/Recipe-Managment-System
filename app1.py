...
mock_data = {
    "1001": {
        "0": {"stations": [1, 3], "mazzanine": 21, "order_id": 1}
        # "1": {"stations": [2, 4, 7], "mazzanine": 15, "order_id": 2}
    },
    "1002": {
        # "0": {"stations": [5, 8, 10], "mazzanine": 19, "order_id": 3},
        "1": {"stations": [3, 9, 12], "mazzanine": 25, "order_id": 4}
    },
    "1003": {
        # "0": {"stations": [5, 8, 10], "mazzanine": 19, "order_id": 3},
        "1": {"stations": [7, 8, 11], "mazzanine": 25, "order_id": 5}
    }
    
}
mock_data1={
    '1001': [1,3],  # Tray 1001 is valid for stations 1, 2, 3
    '1002': [3,9,12]      # Tray 1002 is valid for stations 1, 2
}